...
@Injectable(as: IUserLoginDataSource)
class UserLoginDatasource implements IUserLoginDataSource {
  ...
  Future<void> loginUser(String email, String password) async {
    try {
      ...
      if(e.response.statusCode == 401) throw LoginErrorInvalidUserOrPassword();
      throw LoginErrorServer(message: e.response.statusMessage);
    } catch (e) {
